 ...
 */
final class Version20220329120908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE note (id INT AUTO_INCREMENT NOT NULL, note DOUBLE PRECISION NOT NULL, coefficient DOUBLE PRECISION NOT NULL, date DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
